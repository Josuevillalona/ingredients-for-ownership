"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{Bt:function(){return sx},EK:function(){return P},ET:function(){return sk},IO:function(){return ss},JU:function(){return iL},PL:function(){return sC},QT:function(){return sT},Xo:function(){return sh},ad:function(){return iO},ar:function(){return so},b9:function(){return sd},hJ:function(){return ix},oe:function(){return sN},pl:function(){return sA},qs:function(){return sL},r7:function(){return sS}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sT(e){e=iS(e,iD);let t=iS(e.firestore,iM);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:o=>{s.Za(),t.enqueueAndForget(()=>rq(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rK(new e8(n.path),s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(iF(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new sI(e);return new sw(e,i,t._key,r,new sv(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sI extends sg{constructor(e){super(),this.firestore=e}convertBytes(e){return new iP(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iD(this.firestore,null,t)}}function sC(e){e=iS(e,ib);let t=iS(e.firestore,iM),n=iF(t),r=new sI(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new A(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:n=>{s.Za(),t.enqueueAndForget(()=>rq(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rK(n,s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sE(t,r,e,n)))}function sA(e,t,n){e=iS(e,iD);let r=iS(e.firestore,iM),i=sy(e.converter,t,n);return sb(r,[iY(iH(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tx.none())])}function sS(e,t,n,...r){e=iS(e,iD);let i=iS(e.firestore,iM),s=iH(i);return sb(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iU?i0(s,"updateDoc",e._key,t,n,r):iZ(s,"updateDoc",e._key,t)).toMutation(e._key,tx.exists(!0))])}function sN(e){return sb(iS(e.firestore,iM),[new tz(e._key,tx.none())])}function sk(e,t){let n=iS(e.firestore,iM),r=iL(e),i=sy(e.converter,t);return sb(n,[iY(iH(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tx.exists(!1))]).then(()=>r)}function sb(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r3(await iv(e).then(e=>e.syncEngine),t,n)),n.promise}(iF(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sD{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=iH(e)}set(e,t,n){this._verifyNotCommitted();let r=sR(e,this._firestore),i=sy(r.converter,t,n),s=iY(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(s.toMutation(r._key,tx.none())),this}update(e,t,n,...r){let i;this._verifyNotCommitted();let s=sR(e,this._firestore);return i="string"==typeof(t=(0,h.m9)(t))||t instanceof iU?i0(this._dataReader,"WriteBatch.update",s._key,t,n,r):iZ(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,tx.exists(!0))),this}delete(e){this._verifyNotCommitted();let t=sR(e,this._firestore);return this._mutations=this._mutations.concat(new tz(t._key,tx.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new A(C.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function sR(e,t){if((e=(0,h.m9)(e)).firestore!==t)throw new A(C.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}function sx(){return new iJ("serverTimestamp")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
